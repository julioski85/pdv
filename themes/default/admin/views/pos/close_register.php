        ...
        <div class="modal-body">
            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    ...
                    <td style="text-align:right;border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->sma->formatMoney($debit_cardsales->paid ? $debit_cardsales->paid : '0.00') . ' (' . $this->sma->formatMoney($debit_cardsales->total ? $debit_cardsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
            ...
            <div class="row no-print">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <?= form_hidden('total_cc_slips',$debit_cardsales->total_cc_slips+$ccsales->total_cc_slips + $db); ?>
                        <?= form_input('total_cc_slips_submitted', ($_POST['total_cc_slips_submitted'] ??$debit_cardsales->total_cc_slips+$ccsales->total_cc_slips ?? 0), 'class="form-control input-tip" id="total_cc_slips_submitted" required="required"'); ?>
                    </div>
                </div>
            </div>
