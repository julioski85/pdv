...
<div class="modal-dialog no-modal-header" role="document"><div class="modal-content"><div class="modal-body">
    ...
    <div id="wrapper" style="word-wrap: break-word;">
        <div id="receiptData">
            <div class="no-print">
                <?php
                if ($message) {
            ...
            <?php
            if($sat){
                echo '<p style="font-size:8px;">' . lang('CfdiSign') . ': ' . $sat->CfdiSign. '<br>';
                echo '<p style="font-size:8px;">' . lang('SatCertNumber') . ': ' . $sat->SatCertNumber. '<br>';
                echo '<p style="font-size:8px;">' . lang('SatSign') . ': ' . $sat->SatSign. '<br>';
                echo '<p style="font-size:8px;">' . lang('RfcProvCertif') . ': ' . $sat->RfcProvCertif. '<br>';
            }
