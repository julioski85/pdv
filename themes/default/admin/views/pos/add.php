                    ...
                    <div id="leftdiv">
                        ...
                        <div id="print">
                            ...
                            <div id="left-bottom">
                                ...
                                <input type="hidden" name="forma_de_pago" value="" id="forma_de_pago">
                                <input type="hidden" name="metodo_de_pago" value="" id="metodo_de_pago">
                                <input type="hidden" name="uso_de_cfdi" value="" id="uso_de_cfdi">
                                <input type="hidden" name="requiere_factura" value="0" id="requiere_factura">
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        <div class="form-group">
                            <?=lang('require_factura','require_fractura');?>
                            <input type="checkbox" class="checkbox" name="attributes"
                                   id="requierefactura" >
                        </div>
                       <div id="opciones_factura" style="display:none">
                            <div class="form-group">
                                <label for="formas_de_pago">Forma De Pago</label>
                                <?=form_dropdown("formas_de_pago",$this->factura->getFormaDePago(),"",'class="form-control" id="formasdepago" required="required"');?>
                            </div>
                            <div class="form-group">
                                <label for="metodo_de_pago">Metodo de pago</label>
                                <?=form_dropdown("metodo_de_pago",$this->factura->getMetodoDePago(),"",'class="form-control" id="metododepago" required="required"');?>
                            </div>
                            <div class="form-group">
                                <label for="uso_de_cfdi">Uso de CFDI</label>
                                <?=form_dropdown("uso_de_cfdi",$this->factura->getUsoDeCfdi(),"",'class="form-control" id="usodecfdi" required="required"');?>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#forma_de_pago").val(null)
        $("#metodo_de_pago").val(null)
        $("#uso_de_cfdi").val(null)
        
        $("#formasdepago").change(function(){
        var valor= $(this).val();
        $("#forma_de_pago").val(valor);
        });
        $("#metododepago").change(function(){
        var valor= $(this).val();
        $("#metodo_de_pago").val(valor);
        });
        $("#usodecfdi").change(function(){
        var valor= $(this).val();
        $("#uso_de_cfdi").val(valor);
        });


        $('#requierefactura').change(function(){
        if($(this).is(':checked')){
            $("#forma_de_pago").val($("#formasdepago").val())
            $("#metodo_de_pago").val($("#metododepago").val())
            $("#uso_de_cfdi").val($("#usodecfdi").val())
            $("#requiere_factura").val(1);
            $('#opciones_factura').show();
        } else {
            
            $("#requiere_factura").val(0);
            $('#opciones_factura').hide();
        }
        });
