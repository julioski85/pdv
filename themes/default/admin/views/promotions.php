        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module for BioMaussan POS Advance</h1>
                    <p class="lead">BioMaussan POS Advance is php based web application for small and medium business to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                    <p>Please edit themes/<?=$Settings->theme;?>/admin/views/promotions.php</p>
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>BioMaussan POS Advacne by <a href="http://biomaussanpos.com">biomaussanpos</a>.</p>
                    </div>
                </div>
            </div>
        </div>
