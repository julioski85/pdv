...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
		    ...
		    <div class="form-group">
                        <?= lang('rfc', 'rfc'); ?>
                        <?php echo form_input('rfc', '', 'class="form-control" id="rfc"'); ?>
                    </div>
		    <div class="form-group">
                        <?= lang('contraseña', 'contraseña'); ?>
                        <?php echo form_input('contraseña', '', 'class="form-control" id="contraseña"'); ?>
                    </div>

                    <div class="form-group">
                        <?= lang('clave_privada', 'clave_privada'); ?>
                        <input id="clave_privada" type="file" data-browse-label="<?= lang('browse'); ?>" name="clave_privada" data-show-upload="false"
                               data-show-preview="false" accept=".key" class="form-control file">

                    </div>
                    <div class="form-group">
                        <?= lang('certificado', 'certificado'); ?>
                        <input id="certificado" type="file" data-browse-label="<?= lang('browse'); ?>" name="certificado" data-show-upload="false"
                               data-show-preview="false" accept=".cer" class="form-control file">  
                    </div>
                   <div class="form-group">
                        <?= lang('regimen_fiscal', 'regimen_fiscal'); ?>
                        <?php
                             $rf = $this->factura->getRegimenesFiscales();
                             echo form_dropdown('regimen_fiscal', $rf, '', 'class="form-control" id="regimen_fiscal"');
                        ?>
                    </div>
