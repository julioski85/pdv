        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                        ...
                        <?php echo form_input('postal_code', $customer->postal_code, 'class="form-control" id="postal_code" required="required"'); ?>
                    </div>
                    <div class="form-group">
            ...
            <!--         <div class="form-group">
                    ...
                    <div class="form-group">
                        <?= lang('rfc', 'rfc'); ?>
                        <?php echo form_input('rfc',$customer->rfc, 'class="form-control" id="rfc" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('regimen_fiscal', 'regimen_fiscal'); ?>
                        <?php
                             $rf = $this->factura->getRegimenesFiscales();
                             echo form_dropdown('regimen_fiscal', $rf, $customer->regimen_fiscal, 'class="form-control" id="regimen_fiscal" required="required"');
                        ?>
                    </div>
                </div>
            </div>
