 ...
 *  For       : BioMaussan POS Advance
 *  Web       : http://biomaussanpos.com
 *  ==============================================================================
 */
...
class Sma
{
    ...
    public function paid_opts($paid_by = null, $purchase = false, $empty_opt = false)
    {
        ...
        <option value="debit_card"' . ($paid_by && 'cash' == $paid_by ? ' selected="selected"' : '') . '>' . lang('debit_card') . '</option>
    ...
    public function qrcode($type = 'text', $text = 'http://biomaussanpos.com', $size = 2, $level = 'H', $sq = null, $svg = false)
    {
        if ('link' == $type) {
            $text = urldecode($text);
        }
    ...
    public function send_email($to, $subject, $message, $from = null, $from_name = null, $attachment = null, $cc = null, $bcc = null)
    {
        ...
        if ('biomaussanpos.com' != $domain || DEMO) {
            $result = false;
