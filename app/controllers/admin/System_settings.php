...
class system_settings extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = ['site_name' => DEMO ? 'BioMaussan POS Advance' : $this->input->post('site_name'),
                ...
                'default_email'        => DEMO ? 'noreply@biomaussanpos.com' : $this->input->post('email'),
                'language'             => $lang,
    ...
    public function updates()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $updates               = get_remote_contents($protocol . 'api.biomaussanpos.com/v1/update/', $fields);
