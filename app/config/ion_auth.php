 ...
 */
$config['site_title']                 = "BioMaussan POS Advance";       // Site Title, example.com This is not more functional
$config['admin_email']                = "contact@biomaussanpos.com"; // Admin Email, admin@example.com This is not more functional
